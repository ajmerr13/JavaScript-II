...
const gigaEmployee = runners.filter(function(currentValue){
  return currentValue.company_name === 'Gigashots';
});
//console.log(gigaEmployee)

// Problem 2

const money = runners.sort(function (a, b) {
  return a.donation - b.donation;
});
//console.log(money);
// Problem 3
what runners wear XL shirts


const runnersBigShirts = runners.filter(function(currentValue){
  return currentValue.shirt_size === '2XL';
});
console.log(runnersBigShirts)